...
const Blog = () => {
  ...
  return (
    <PageLayout>
      <SEO 
        title="Car News - Latest Automotive Industry Updates & Reviews" 
        description="Stay updated with the latest automotive news, car reviews, industry trends, and vehicle launches from around the world."
        imageUrl={featuredPost?.imageUrl || "/lovable-uploads/37999ffc-9cf9-4d97-8f56-0ec7fd532245.png"}
        keywords={['car news', 'automotive industry', 'vehicle reviews', 'car launches', 'auto trends', 'car technology']}
        type="website"
      />
      
      <div className="w-full pt-24 pb-12 bg-gradient-to-b from-primary to-primary/80 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Car News &amp; Reviews</h1>
          ...
          {otherPosts.map((post) => (
           ...
           {blogPosts.length < 4 && Array.from({ length: Math.max(0, 4 - blogPosts.length) }).map((_, index) => (
             <BlogPostCard 
               ...
               excerpt="Stay tuned for more exciting articles about cars, automotive technology, and industry news."
               imageUrl={index % 2 === 0 ? "/lovable-uploads/37999ffc-9cf9-4d97-8f56-0ec7fd532245.png" : "/assets/ferrari-front.jpg"}
               date="Coming soon"
               slug="#"
               category="Upcoming"
             />
